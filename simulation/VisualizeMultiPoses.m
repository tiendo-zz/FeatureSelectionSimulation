...
DrawAxis(-AbsolutePoses(:,1:3,newPose)'*AbsolutePoses(:,4,newPose), AbsolutePoses(:,1:3,newPose)', scale);
DrawCamera(-AbsolutePoses(:,1:3,newPose)'*AbsolutePoses(:,4,newPose), AbsolutePoses(:,1:3,newPose)', scale , 'm');
