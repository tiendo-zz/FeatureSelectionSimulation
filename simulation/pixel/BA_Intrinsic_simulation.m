function [FeatureBag, AbsolutePoses, CameraParams,normHist, gradnormHist,error] = BA_Intrinsic_simulation(FeatureBag, AbsolutePoses, PoseGraphMatrix, featureExtracted, usedPoses, CameraParams)
