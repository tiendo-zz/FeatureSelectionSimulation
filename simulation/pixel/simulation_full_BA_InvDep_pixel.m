function [AbsolutePoses,FeaturesBag,measurePoses,CameraParams] = simulation_full_BA_InvDep_pixel(PoseGraphMatrix,AbsolutePoses,featureExtracted,NumOfPoses,CameraParams)
...
%           end
          ...
          %% 6. nonlinear PnP
          [Cn_R_Cr, Cn_t_Cr, normHist] = simulation_PnP_NL_InvDep_pixel(Cn_R_Cr, Cn_t_Cr,AbsolutePoses, Cr_P(:, InlierIdx), Cn_z(InlierIdx,:)',CameraParams);                  
...
%           [FeaturesBag, AbsolutePoses, ~, ~,~,~] = BA_InverseDepth_simulation(FeaturesBag, AbsolutePoses, PoseGraphMatrix, featureExtracted, measurePoses, CameraParams);
          [FeaturesBag, AbsolutePoses,CameraParams, PoseGraphMatrix, ~,~,~] = BA_InverseDepth_2viewBLS_Robust_pixel_simulation(FeaturesBag, AbsolutePoses, PoseGraphMatrix, featureExtracted, measurePoses, CameraParams,60);
       end       
    end
