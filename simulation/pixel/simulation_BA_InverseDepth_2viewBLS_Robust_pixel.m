function [FeatureBag, AbsolutePoses, CameraParams,normHist, gradnormHist,EraseId,error] = simulation_BA_InverseDepth_2viewBLS_Robust_pixel(FeatureBag, AbsolutePoses, PoseGraphMatrix, featureExtracted, usedPoses, CameraParams,sigma)
...
for featk = featureAvailableList %0:size(PoseGraphMatrix,1)-1
   ...
   for l = 0:length(poses_see_featk)-1
      ...
      [Jfc,Jcc,residual_tmp,flag] = dprojection_dfc_dcc_simulation(Cr_p_f, Ck_R_W, W_R_Cr,W_p_Cr, W_p_Ck, Ck_z_f,CameraParams);
