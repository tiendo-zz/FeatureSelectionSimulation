function [FeatureBag_true_InvDepth, FeatureBag_true_xyz, featureExtracted_true, AbsolutePoses_true, PoseGraphMatrix] = GenerateGroundTruth_StraightSideWay(NumOfFeatures, NumOfPoses)
...
for k = 1:NumOfPoses
    ...
    theta = k/NumOfPoses*y_range;
    WpC = [x_range/2;theta*alpha;10];
