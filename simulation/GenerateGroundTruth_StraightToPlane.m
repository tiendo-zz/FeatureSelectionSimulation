function [FeatureBag_true_InvDepth, FeatureBag_true_xyz, featureExtracted_true, AbsolutePoses_true, PoseGraphMatrix] = GenerateGroundTruth_StraightToPlane(NumOfFeatures, NumOfPoses)
...
for k = 1:NumOfPoses
    ...
    WpC = [x_range/2;y_range/2;10-theta*alpha];
