...
%        match_id_candid = measurePoses(end); 
       ...
       if backselection == 1
          [PairWiseMatches,PairWiseMatches_homo,featureExtracted,match_image_id,ImageId,t] = Matching_backselection(newPose,featureExtracted,match_id_candid,CameraParams,measurePosesId,rate,NumOfPoses,t);         
       else
       ...
       if length(measurePosesId)>2&&((ImageId == measurePosesId(end))||(ImageId == measurePosesId(end-1))) 
           return;
       end
