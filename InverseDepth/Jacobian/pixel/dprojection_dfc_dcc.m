function [Jfc,Jcc,residual,flag] = dprojection_dfc_dcc(Cr_p_f, Ci_R_G, G_R_Cr,G_p_Cr, G_p_Ci, Ci_z_f,CameraParams,CameraModel,thresh)
...
for k = 0:featureNums-1 
    ...
    Ci_z_f_hat(:,k+1) = StaticDistort(CameraParams.fc,CameraParams.cc,CameraParams.kc,homo,CameraModel);
...
%     gamma = residual_tmp'*(10^-2)*residual_tmp;
...
%     end
    ...
    Jfc(2*row_count+1:2*row_count+2,:) = StaticPixelToCameraIntrinsicsDerivative(homo,CameraParams.kc,CameraModel);  
