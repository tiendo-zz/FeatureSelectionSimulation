function [FeatureBag, AbsolutePoses, normHist, gradnormHist,EraseId] = BA_InverseDepth_2viewBLS(FeatureBag, AbsolutePoses, PoseGraphMatrix, featureExtracted, usedPoses, CameraParams)
